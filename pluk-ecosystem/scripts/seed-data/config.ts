...
// Load Amplify configuration with hardcoded values
const amplifyConfig = {
...
export const seedConfig = {
  // Number of records to create - using smaller numbers for testing
  userCount: 5,
  farmCount: 2,
  produceCategoryCount: 3,
  produceSubcategoryCount: 2, // per category
  produceTypeCount: 2, // per subcategory
  produceVarietyCount: 1, // per type
  inventoryBatchCount: 2, // per farm
  preHarvestListingCount: 1, // per inventory batch
  farmPostCount: 2, // per farm
  produceListingCount: 3, // per farm
